  ...
  where
    ...
    normalizeTarget tot mset tgt =
      let num = transitionCount mset (srcNode, tgt)
          numSq = num * num
          frac = mkMSetFractionVexel (AddM (MkSing tgt) (intToBoxInt numSq) ZeroM) (intToBoxInt tot)
...
public export
prop_indivisibleHistoryLength : Property
prop_indivisibleHistoryLength = property (
  let start = MkPixel 0 0
      p1 = MkPixel 1 1
      p2 = MkPixel 2 0
      h0 = Origin start
      h1 = Step h0 p1 Blue
      h2 = Step h1 p2 Blue
      len0 = historyLength h0
      len1 = historyLength h1
      len2 = historyLength h2
      div0 = isDivisionEvent h0
      div1 = isDivisionEvent h1
      div2 = isDivisionEvent h2
  in len0 == 1 && len1 == 2 && len2 == 3 && not div0 && not div1 && div2)
